    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-600 items-center justify-center p-12">
        <div className="text-center text-white">
          ...
          <p className="text-xl text-indigo-100 mb-8">
            Join thousands of students transforming how they learn with AI-powered voice tutoring
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full space-y-8">
          <Link to="/" className="inline-flex items-center space-x-2 text-gray-600 hover:text-indigo-600 transition-colors">
